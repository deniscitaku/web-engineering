...
<div class="parallax" style="height: 25em">
    <div class="parallax__background parallax__background--about-us"></div>
    <div class="parallax__body parallax__body--left">
        <h1>History of ZOO</h1>
...
<div class="bg-about">
    <div class="wood-header">
        ...
        <div class="wood-header__content">
            <h2 class="primary-color">ZOO MAP</h2>
        </div>
    </div>
    <div class="map">
        <img src="../../static/images/zoo-map.png">
    </div>
</div>
<div class="divider"></div>
<footer>
